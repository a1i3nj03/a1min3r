...
__host__
void x16_hamsi512_setBlock_80(int thr_id, void *dat)
{
	uint64_t *pdata = (uint64_t*)dat;
	unsigned char h1[80];
...
__host__
void x16_hamsi512_cuda_hash_80(int thr_id, const uint32_t threads, const uint32_t startNounce, uint32_t *d_hash, volatile int *order)
{
...
__host__
void x13_hamsi512_cpu_hash_64(int thr_id, uint32_t threads, uint32_t startNounce, uint32_t *d_hash, volatile int *order)
{
	...
	x13_hamsi512_gpu_hash_64 << <grid, block >> >(threads, startNounce, (uint64_t*)d_hash, NULL);
